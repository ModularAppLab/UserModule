...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/ModularAppLab/UserModule"
  ...
  s.source       = { :git => "https://github.com/ModularAppLab/UserModule.git", :tag => s.version.to_s }
  ...
  s.source_files  = "UserModule/UserModule/**/*.{h,m}"
  ...
  s.dependency "MediatorReservationModuleCategory"
end
